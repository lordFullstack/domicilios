-- Rollback de LOOP_CLIENT_05C · M7: restaura create_order de 7 parámetros (versión de M5).
drop function if exists public.create_order(uuid, text, text, text, jsonb, uuid, integer, text);
