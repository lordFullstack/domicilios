    ...
    <div className="px-5 pb-3">
      <div className="relative">
        ...
        <input
          ...
          className="focus-ring w-full min-h-[48px] bg-gray-50 rounded-2xl pl-11 pr-11 text-sm placeholder:text-gray-400 focus:bg-white focus:border focus:border-primary transition-colors"
        />
        {value && (
          <button
            onClick={() => onChange('')}
