    ...
    <div className="flex flex-col gap-2 mb-8">
      {alerts.map((alert, i) => (
        <button
          ...
          className="flex items-center gap-2 bg-warning/10 text-warning-strong text-sm font-semibold rounded-2xl p-3 text-left hover:bg-warning/20 transition-colors"
        >
