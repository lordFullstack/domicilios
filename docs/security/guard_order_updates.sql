...
comment on function private.guard_order_update() is
  'BEFORE UPDATE en orders: solo permite los cambios que hace la app por rol (cliente cancela; restaurante avanza estados/envía; domiciliario toma, ubica, entrega y cobra efectivo). Admin y service_role sin restricción.';
